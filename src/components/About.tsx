...
const About = () => {
  ...
  return (
    <section id="about" className="py-8 xs:py-10 sm:py-12 md:py-16 lg:py-20 bg-indigo-50">
      <div className="container mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-display text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold  text-indigo-900 mb-2 xs:mb-3 sm:mb-4">
            About <span className="font-script text-indigo-700 italic">Kalakar</span> Art Academy
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-6 xs:gap-8 lg:gap-12 items-center mb-8 xs:mb-10 sm:mb-12 md:mb-16">
          ...
          >
            <div className="relative">
              ...
              <motion.div
                className="absolute -bottom-2 -right-2 xs:-bottom-3 xs:-right-3 sm:-bottom-4 sm:-right-4 md:-bottom-6 md:-right-6 w-12 h-12 xs:w-16 xs:h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-32 lg:h-32 bg-indigo-600 rounded-xl xs:rounded-2xl flex items-center justify-center"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 xs:gap-6 sm:gap-8 lg:gap-10">
          {features.map((feature, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
            >
              <div className="w-10 h-10 xs:w-12 xs:h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-gradient-to-br from-indigo-600 to-blue-500 rounded-xl xs:rounded-2xl flex items-center justify-center mb-3 xs:mb-4 sm:mb-6">
